...
USE [master]
GO
ALTER AVAILABILITY GROUP [CSR_AG]
MODIFY REPLICA ON N'ATLSQLDBCN08\CSR' WITH (FAILOVER_MODE = MANUAL);
GO
ALTER AVAILABILITY GROUP [CSR_AG]
MODIFY REPLICA ON N'ATLSQLDBCN07\CSR' WITH (FAILOVER_MODE = MANUAL);
...
MODIFY REPLICA ON N'ATLSQLDBCN08\DE' WITH (FAILOVER_MODE = MANUAL);
GO
ALTER AVAILABILITY GROUP [Delaware_AG]
MODIFY REPLICA ON N'ATLSQLDBCN07\DE' WITH (FAILOVER_MODE = MANUAL);
SELECT replica_server_name, failover_mode_desc FROM sys.availability_replicas;
GO
...
MODIFY REPLICA ON N'ATLSQLDBCN08\IND' WITH (FAILOVER_MODE = MANUAL);
GO
ALTER AVAILABILITY GROUP [Indiana_AG]
MODIFY REPLICA ON N'ATLSQLDBCN07\IND' WITH (FAILOVER_MODE = MANUAL);
SELECT replica_server_name, failover_mode_desc FROM sys.availability_replicas;
GO
...
MODIFY REPLICA ON N'ATLSQLDBCN08\KY' WITH (FAILOVER_MODE = MANUAL);
GO
ALTER AVAILABILITY GROUP [Kentucky_AG]
MODIFY REPLICA ON N'ATLSQLDBCN07\KY' WITH (FAILOVER_MODE = MANUAL);
SELECT replica_server_name, failover_mode_desc FROM sys.availability_replicas;
GO
...
MODIFY REPLICA ON N'ATLSQLDBCN08\MI' WITH (FAILOVER_MODE = MANUAL);
GO
ALTER AVAILABILITY GROUP [Michigan_AG]
MODIFY REPLICA ON N'ATLSQLDBCN07\MI' WITH (FAILOVER_MODE = MANUAL);
SELECT replica_server_name, failover_mode_desc FROM sys.availability_replicas;
GO
...
-- CSR
:CONNECT SQLPRD-VTC-CSR.Atlanta.ver.com,1108
USE [master]
GO
...
USE [msdb]
GO
EXEC dbo.sp_update_job @job_name = 'DatabaseBackup - CSR - FULL', @enabled = 0;
...
EXEC dbo.sp_update_job @job_name = 'DatabaseIntegrityCheck - CSR', @enabled = 0;
EXEC dbo.sp_update_job @job_name = 'DatabaseIntegrityCheck - SYSTEM_DATABASES', @enabled = 0;
EXEC dbo.sp_update_job @job_name = 'IndexOptimize - CSR', @enabled = 0;
...
GO
EXEC dbo.sp_update_job @job_name = 'DatabaseBackup - SYSTEM_DATABASES - FULL', @enabled = 0;
EXEC dbo.sp_update_job @job_name = 'DatabaseBackup - USER_DATABASES - FULL', @enabled = 0;
EXEC dbo.sp_update_job @job_name = 'DatabaseBackup - USER_DATABASES - LOG', @enabled = 0;
EXEC dbo.sp_update_job @job_name = 'DatabaseIntegrityCheck - SYSTEM_DATABASES', @enabled = 0;
EXEC dbo.sp_update_job @job_name = 'DatabaseIntegrityCheck - USER_DATABASES', @enabled = 0;
EXEC dbo.sp_update_job @job_name = 'IndexOptimize - USER_DATABASES', @enabled = 0;
EXEC dbo.sp_update_job @job_name = 'MI Archive Step 1', @enabled = 0;
EXEC dbo.sp_update_job @job_name = 'MI Archive Step 2', @enabled = 0;
EXEC dbo.sp_update_job @job_name = 'MI Archive Step 3', @enabled = 0;
--EXEC dbo.sp_update_job @job_name = 'MIDPP AutoClose Transaction', @enabled = 0;
EXEC dbo.sp_update_job @job_name = 'MIDPP Lender Invoice', @enabled = 0;
EXEC dbo.sp_update_job @job_name = 'MIDPP State Remit Invoice', @enabled = 0;
EXEC dbo.sp_update_job @job_name = 'SQL Sentry 2.0 Alert Trap', @enabled = 0;
EXEC dbo.sp_update_job @job_name = 'syspolicy_purge_history', @enabled = 0;
EXEC dbo.sp_update_job @job_name = 'Veritec - Monthly - EOM Restore', @enabled = 0;
EXEC dbo.sp_update_job @job_name = 'Veritec - Weekly - MIDPPArchive Restore', @enabled = 0;
GO
...
USE [master]
GO
BACKUP DATABASE [CSR] TO DISK = '\\ATLSQLFS01\ProdSQLBackups\CSR_2016_FULL.bak' WITH INIT, COPY_ONLY, STATS=10;
GO
-- DE
:CONNECT ATLSQLDBCN07.Atlanta.ver.com,1104
USE [master]
...
USE [master]
GO
ALTER AVAILABILITY GROUP CSR_AG FAILOVER;  
GO 
-- DE
:CONNECT ATLSQLDBCN08.Atlanta.ver.com,1104
USE [master]
...
USE [msdb]
GO
EXEC dbo.sp_update_job @job_name = 'DatabaseBackup - CSR - FULL', @enabled = 1;
...
EXEC dbo.sp_update_job @job_name = 'DatabaseIntegrityCheck - CSR', @enabled = 1;
EXEC dbo.sp_update_job @job_name = 'DatabaseIntegrityCheck - SYSTEM_DATABASES', @enabled = 1;
EXEC dbo.sp_update_job @job_name = 'IndexOptimize - CSR', @enabled = 1;
...
GO
ALTER AVAILABILITY GROUP [CSR_AG]
MODIFY REPLICA ON N'ATLSQLDBCN08\CSR' WITH (FAILOVER_MODE = AUTOMATIC);
GO
ALTER AVAILABILITY GROUP [CSR_AG]
MODIFY REPLICA ON N'ATLSQLDBCN07\CSR' WITH (FAILOVER_MODE = AUTOMATIC);
SELECT replica_server_name, failover_mode_desc FROM sys.availability_replicas;
GO
...
USE [msdb]
GO
EXEC dbo.sp_start_job @job_name = 'DatabaseIntegrityCheck - CSR';
GO
-- DE
:CONNECT SQLPRD-VTC-DE.Atlanta.ver.com,1104
USE [msdb]
...
USE [msdb]
GO
EXEC dbo.sp_start_job @job_name = 'DatabaseBackup - CSR - FULL';
GO
-- DE
:CONNECT ATLSQLDBCN07.Atlanta.ver.com,1104
USE [msdb]
